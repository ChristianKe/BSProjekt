...
public class FZAFrame extends JFrame  {
	...
	public FZAFrame(User currentUser) throws HeadlessException {
		...
		// Button zum Anlegen eines neuen Users nur f�r Admins
		...
		// Button zum Bearbeiten eines Users nur f�r Admins
		...
		// Button zum Anlegen eines neuen Fahrzeugs nur f�r Admins
		...
		// Button zum Bearbeiten eine Fahrzeugs nur f�r Admins
		...
		// Initialisierung de Logout-Button Icon m�glich
...
// ende Konstruktor		
	...
	private void neuerUserAnlegen(String pName, String pVorname, String pAnmeldeNamen, String pPasswort, String pGroupId) throws ClassNotFoundException, SQLException, IOException {
		...
		if (groupID != null) {
			...
			if (newUserInputValid(inputNewUser)) {
			    ...
			    stmt.setInt( 5, Integer.parseInt( groupID ) );
	...
	// Bestaetigung das ein neuer User angelegt wurde
	...
	//Ue�berpruefung ob alle * Felder bef�llt
